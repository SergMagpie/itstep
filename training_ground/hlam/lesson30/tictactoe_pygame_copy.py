...
class TicTacClient:
    ...
    def run_game(self):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
            ...
            server_address = ('8.tcp.ngrok.io', 15273)
    ...
    while running:
        ...
        if player_name:
            if not game.is_alive():
                ...
                first_answer = True
        draw_text(screen, text1, 40, 300, 600)
        draw_text(screen, text2, 40, 300, 670)
        draw_text(screen, text3, 40, 300, 740)
        draw_text(screen, text4, 40, 300, 810)
